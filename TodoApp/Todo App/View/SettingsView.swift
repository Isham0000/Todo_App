            ...
            VStack(alignment: .center, spacing: 0) {
                ...
                Form {
                    ...
                    Section(header: Text("Follow us on social media")) {
                        ...
                        FormRowLinkView(icon: "link", color: Color.blue, text: "Facebook", link: "https://www.facebook.com/profile.php?id=100009241710501")
                        FormRowLinkView(icon: "play.rectangle", color: Color.green, text: "Instagram", link: "https://www.instagram.com/gordlarox/")
                    } //: SECTION 3
                    .padding(.vertical, 3)
